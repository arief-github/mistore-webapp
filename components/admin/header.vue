          ...
          <div class="dropdown-header bg-light py-2 rounded">
            ...
            <a href="#" class="dropdown-item">
              <svg class="c-icon mr-2">
                <use
                  xlink:href="@/node_modules/@coreui/icons/sprites/free.svg#cilfolder"
                ></use>
              </svg>
              Categories</a
            ...
            <svg class="c-icon mr-2">
              <use
                xlink:href="@/node_modules/@coreui/icons/sprites/free.svg#cillayers"
              ></use>
            </svg>
            Products</a
          ><a class="dropdown-item" href="#">
            <svg class="c-icon mr-2">
              <use
                xlink:href="@/node_modules/@coreui/icons/sprites/free.svg#ciluser"
              ></use>
            </svg>
            Customers</a
          >
            ...
            <a class="dropdown-item" href="#">
              <svg class="c-icon mr-2">
                <use
                  xlink:href="@/node_modules/@coreui/icons/sprites/free.svg#cilcart"
                ></use>
              </svg>
              Invoices</a
            >
            ...
            <a class="dropdown-item" role="button" @click="logout">
              <svg class="c-icon mr-2">
                <use
                  xlink:href="@/node_modules/@coreui/icons/sprites/free.svg#cil-accountlogout"
                ></use>
              </svg>
              Logout
            </a>
