          ...
          <div class="col-md-12">
            <div class="card border-0 rounded shadow-sm border-top-orange">
              <div class="card-header">
                <span class="font-weight-bold"><i class="fa fausers"></i> ADD NEW USER</span>
              </div>
              <div class="card-body">
...
export default {
  ...
  methods: {
    async storeUser() {
      ...
      // sending data to "storeUser" vuex
