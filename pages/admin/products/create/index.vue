            ...
            <div class="card border-0 rounded shadow-sm border-top-orange">
              <div class="card-header">
                <span class="font-weight-bold">
                  <i class="fa fa-folder"></i> ADD NEW PRODUCT
                </span>
              </div>
              <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" v-model="product.title" placeholder="Masukkan Nama Produk" class="form-control">
...
<script>
  export default {
    ...
    // hook asyncData for displaying all categories
