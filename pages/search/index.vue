        ...
        <div class="card h-100 border-0 rounded shadow-sm">
          <div class="card-body">
            <div class="card-img-actions">
              <img :src="product.image" alt="product image" class="card-img img-fluid">
            </div>
          </div>
          <div class="card-body bg-light-custom text-center rounded-bottom">
            <div class="mb-2">
              ...
              <h6 class="mb-0 font-weight-semibold">
                ...
                </s> / <strong> {{ product.discount }} % </strong>
              </h6>
...
export default {
  head() {
    return {
      title: `Pencarian Untuk : ${this.$route.query.q} - MI STORE - Distribusi Xiaomi Indonesia Resmi`
    }
  },
  watchQuery: ["q"],
